    ...
    return base.copyWith(
      ...
      textTheme: GoogleFonts.dmSansTextTheme(base.textTheme).copyWith(
        displayLarge: GoogleFonts.playfairDisplay(
          color: AppColors.textPrimary, fontSize: 36, fontWeight: FontWeight.w700, letterSpacing: -0.5,
        ),
        displayMedium: GoogleFonts.playfairDisplay(
          color: AppColors.textPrimary, fontSize: 28, fontWeight: FontWeight.w600,
        ),
        titleLarge: GoogleFonts.dmSans(
          color: AppColors.textPrimary, fontSize: 20, fontWeight: FontWeight.w600, letterSpacing: -0.2,
        ),
        ...
        labelLarge: GoogleFonts.dmSans(
          color: AppColors.background, fontSize: 15, fontWeight: FontWeight.w600, letterSpacing: 0.3,
        ),
      ),
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
        style: ElevatedButton.styleFrom(
          ...
          textStyle: GoogleFonts.dmSans(fontSize: 15, fontWeight: FontWeight.w600, letterSpacing: 0.3),
          elevation: 0,
        ),
      ),
